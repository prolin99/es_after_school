...
/*-----------執行動作判斷區----------*/
	...
	if ($id) {
     ...
     if ($_SESSION['bootstrap'] == '3') {
					 ...
					 <div class='col-md-1 col-xs-1'>{$data['stud_name']}</div> "  ;

					 $main .= "時段：<select class='col-md-2 col-xs-2' name='time_mode'>" ;
					 ...
					 $main .= "</select>" ;
					 $main .= "班別：<select class='col-md-1 col-xs-1' name='class_id_set'>" ;
					 ...
					 $main .= "</select>" ;
					 $main .= "減免：<select class='col-md-2 col-xs-2' name='spec'>" ;
					 ...
					 $main .= "</select>" ;
					 $main .= "<input class='col-md-2 col-xs-2' placeholder='備註說明文字' value='{$data['ps']}' name='ps'></input>" ;
