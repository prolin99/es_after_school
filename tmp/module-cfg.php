<?php
//$Id: module-cfg.php,v 1.1.2.1 2004/10/22 15:26:46 prolin Exp $
...
$MODULE_TABLE_NAME[0] = "afdb_month";
$MODULE_TABLE_NAME[1] = "afdb_sign";
...
//目錄內程式
$school_menu_p = array("signin.php"=>"名單列表","print.php"=>"點名單","signAdmin.php"=>"*期別管理");
...
/*
$SFS_MODULE_SETUP[0] =
	array('var'=>"DEF_STUD_MAX", 'msg'=>"人數上限", 'value'=>25);
$SFS_MODULE_SETUP[1] =
	array('var'=>"DEF_STUD_BACK", 'msg'=>"備取人數", 'value'=>4);	
$SFS_MODULE_SETUP[2] =
	array('var'=>"DEF_CLASS_MAX", 'msg'=>"每班人數上限", 'value'=>3);
$SFS_MODULE_SETUP[3] =
	array('var'=>"DEF_COST", 'msg'=>"預設費用", 'value'=>500);
	
$SFS_MODULE_SETUP[4] =
	array('var'=>"DEF_SIGN_DAYS", 'msg'=>"報名日數", 'value'=>7);
$SFS_MODULE_SETUP[5] =
	array('var'=>"DEF_BEG_TIME", 'msg'=>"報名開始時間", 'value'=>'08:00:00');
$SFS_MODULE_SETUP[6] =
	array('var'=>"DEF_END_TIME", 'msg'=>"報名結束時間", 'value'=>'17:00:00');			
	*/
//$SFS_MODULE_SETUP[0] =
